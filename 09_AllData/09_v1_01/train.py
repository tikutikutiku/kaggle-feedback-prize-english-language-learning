...
if __name__=='__main__':
    ...
    #trn_df = train_df[train_df['essay_id'].isin(trn_ids_list[args.fold][:100])].reset_index(drop=True)
    #val_df = train_df[train_df['essay_id'].isin(val_ids_list[args.fold][:100])].reset_index(drop=True)
    
    trn_df = train_df.copy()
    #unique_ids = train_df['essay_id'].unique()
    #trn_df = train_df[train_df['essay_id'].isin(unique_ids[:100])].reset_index(drop=True)
    val_df = None
