...
if __name__=='__main__':
    ...
    try:
        ...
        trn_df = train_df[train_df['essay_id'].isin(trn_ids_list[args.fold-5])].reset_index(drop=True)
        val_df = train_df[train_df['essay_id'].isin(val_ids_list[args.fold-5])].reset_index(drop=True)
        #trn_df = train_df[train_df['essay_id'].isin(trn_ids_list[args.fold-5][:600])].reset_index(drop=True)
        #val_df = train_df[train_df['essay_id'].isin(val_ids_list[args.fold-5][:600])].reset_index(drop=True)
