...
if __name__=='__main__':
    ...
    # add new target 'avg' and replace original targets by differences
    trn_df['avg'] = trn_df[TARGET_COLS[1:]].mean(axis=1)
    val_df['avg'] = val_df[TARGET_COLS[1:]].mean(axis=1)
    for col in TARGET_COLS[1:]:
        trn_df[col] = trn_df[col] - trn_df['avg']
        val_df[col] = val_df[col] - val_df['avg']
