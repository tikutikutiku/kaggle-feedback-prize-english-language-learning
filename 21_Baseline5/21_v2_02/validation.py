...
if __name__=='__main__':
    ...
    # add new target 'avg' and 'diff_{target_class}'
    trn_df['avg'] = trn_df[TARGET_COLS].mean(axis=1)
    val_df['avg'] = val_df[TARGET_COLS].mean(axis=1)
    for col in TARGET_COLS:
        trn_df[f'diff_{col}'] = trn_df[col] - trn_df['avg']
        val_df[f'diff_{col}'] = val_df[col] - val_df['avg']
